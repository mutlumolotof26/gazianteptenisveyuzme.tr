    ...
    <div>
      ...
      <section className="bg-gradient-to-r from-[#1d3a5c] to-[#163050] text-white py-16">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <p className="text-[#8fd0f0] text-lg">Gaziantep'in köklü spor kulübü</p>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl font-bold text-[#1d3a5c] mb-6">Kulüp Tarihçemiz</h2>
              ...
              <div className="grid grid-cols-2 gap-6">
                {[
                  ...
                  <div key={stat.label} className="text-center p-4 bg-white rounded-xl shadow-sm">
                    <div className="text-3xl font-black text-[#3a8fbf]">{stat.value}</div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white rounded-2xl p-8 shadow-md">
              <div className="w-12 h-12 bg-[#e0f3fc] rounded-xl flex items-center justify-center mb-4">
                <Target className="text-[#3a8fbf]" size={24} />
              </div>
              <h3 className="text-2xl font-bold text-[#1d3a5c] mb-4">Misyonumuz</h3>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-md">
              ...
              <h3 className="text-2xl font-bold text-[#1d3a5c] mb-4">Vizyonumuz</h3>
              <p className="text-gray-600 leading-relaxed">
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4">
          <h2 className="text-3xl font-bold text-[#1d3a5c] text-center mb-10">Değerlerimiz</h2>
