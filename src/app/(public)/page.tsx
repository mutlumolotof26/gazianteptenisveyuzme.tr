...
export default async function HomePage() {
  ...
  return (
    <div>
      ...
      <section style={{
        minHeight: "100vh",
        background: "linear-gradient(160deg, #0f1f30 0%, #1d3a5c 50%, #1a4a7a 100%)",
        position: "relative",
        display: "flex",
        alignItems: "center",
        overflow: "hidden",
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 py-20 text-center w-full" style={{ paddingBottom: 120 }}>
          ...
          <h1 className="font-black text-white mb-5 leading-tight" style={{ fontSize: "clamp(2.2rem,5.5vw,4rem)", fontFamily: "Montserrat,sans-serif" }}>
            ...
            <span className="bg-clip-text text-transparent" style={{ backgroundImage: "linear-gradient(90deg,#e5500a,#8fd0f0)" }}>
              Ulaşmanın Adresi
            </span>
          </h1>
          ...
          <div className="flex gap-4 justify-center flex-wrap mb-14">
            <Link href="/yuzme" className="font-bold rounded-full text-white transition-all hover:-translate-y-0.5"
              style={{ padding: "14px 32px", background: "#e5500a", border: "2px solid #e5500a", fontFamily: "Montserrat,sans-serif", boxShadow: "0 8px 24px rgba(229,80,10,.4)" }}>
              Programları Keşfet
            </Link>
          ...
          <div className="flex gap-10 justify-center items-center flex-wrap">
            {[
              ...
              <div key={i} className="text-center">
                ...
                <span className="text-sm font-semibold" style={{ color: "#8fd0f0" }}>{s.label}</span>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* ===== HIZMETLER ===== */}
      <section style={{ padding: "96px 0", background: "#f4f7fb" }}>
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-14">
            <span className="section-tag">Hizmetlerimiz</span>
            <h2 className="font-black" style={{ fontSize: "clamp(1.8rem,3vw,2.5rem)", color: "#1d3a5c", fontFamily: "Montserrat,sans-serif" }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-7">
            ...
            <div className="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-all hover:-translate-y-1"
              ...
              <div className="p-8 text-white" style={{ background: "linear-gradient(135deg,#1d3a5c,#3a8fbf)" }}>
                <div className="text-5xl mb-4">🏊</div>
                <h3 className="text-2xl font-bold mb-2" style={{ fontFamily: "Montserrat,sans-serif" }}>Yüzme</h3>
                <p style={{ color: "#8fd0f0" }}>Olimpik standartlarda yüzme havuzu ve eğitim</p>
              </div>
              <div className="p-6">
                <ul className="flex flex-col gap-2 mb-6">
                  {["50m olimpik yüzme havuzu", "Çocuk ve yetişkin kursları", "Yüzme okulu programı", "Profesyonel antrenörler"].map(item => (
                    <li key={item} className="flex items-center gap-2 text-sm" style={{ color: "#6b7280" }}>
                      <span className="w-2 h-2 rounded-full shrink-0" style={{ background: "#3a8fbf" }} />
                      {item}
                    </li>
                  ))}
                </ul>
            ...
            <div className="bg-white rounded-2xl overflow-hidden shadow-xl hover:shadow-2xl transition-all"
              style={{ border: "2px solid #e5500a", transform: "translateY(-8px)" }}>
              <div className="relative">
                <span className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 px-4 py-1 rounded-full text-xs font-bold text-white"
                  style={{ background: "#e5500a", fontFamily: "Montserrat,sans-serif" }}>
                  Profesyonel
                </span>
              </div>
              <div className="p-8 text-white" style={{ background: "linear-gradient(135deg,#c44208,#e5500a)" }}>
                <div className="text-5xl mb-4">🎾</div>
              ...
              <div className="p-6">
                <ul className="flex flex-col gap-2 mb-6">
                  {["6 adet profesyonel tenis kortu", "Bireysel ve grup dersleri", "Tüm yaş grupları için program", "Turnuva organizasyonları"].map(item => (
                    <li key={item} className="flex items-center gap-2 text-sm" style={{ color: "#6b7280" }}>
                      <span className="w-2 h-2 rounded-full shrink-0" style={{ background: "#e5500a" }} />
                      {item}
                    </li>
                  ))}
                </ul>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <h2 className="font-black mb-5 leading-tight" style={{ fontSize: "clamp(1.8rem,3vw,2.5rem)", color: "#1d3a5c", fontFamily: "Montserrat,sans-serif" }}>
              ...
              <div className="grid grid-cols-1 gap-3">
                {[
                  ...
                  <div key={f} className="flex items-center gap-3">
                    <CheckCircle size={20} style={{ color: "#e5500a", flexShrink: 0 }} />
                    <span className="text-sm font-semibold" style={{ color: "#1d3a5c" }}>{f}</span>
                  </div>
                ))}
              </div>
              <Link href="/hakkimizda" className="inline-flex items-center gap-2 mt-8 font-bold rounded-full text-white"
                style={{ padding: "14px 32px", background: "#1d3a5c", fontFamily: "Montserrat,sans-serif" }}>
                Daha Fazla Bilgi <ChevronRight size={18} />
              </Link>
            </div>
            <div className="grid grid-cols-2 gap-4">
              {[
                { emoji: "🏊", label: "Olimpik Havuz", bg: "linear-gradient(135deg,#1d3a5c,#3a8fbf)" },
                { emoji: "🎾", label: "Tenis Kortları", bg: "linear-gradient(135deg,#c44208,#e5500a)" },
          ...
          <div className="max-w-6xl mx-auto px-6">
            <div className="flex items-end justify-between mb-12">
              <div>
                ...
                <h2 className="font-black" style={{ fontSize: "clamp(1.8rem,3vw,2.4rem)", color: "#1d3a5c", fontFamily: "Montserrat,sans-serif" }}>
                  Son Haberler
                </h2>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {news.map((item) => (
                <div key={item.id} className="bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-lg transition-all hover:-translate-y-1"
                  style={{ borderTop: "4px solid #5aaddc" }}>
                  {item.resimUrl
                    ...
                    : <div className="w-full h-48 flex items-center justify-center text-5xl"
                        style={{ background: "linear-gradient(135deg,#1d3a5c,#3a8fbf)" }}>🏊</div>
                  }
                  <div className="p-5">
                    <div className="text-xs mb-2" style={{ color: "#6b7280" }}>
                      {new Date(item.yayinTarihi).toLocaleDateString("tr-TR")}
                    </div>
                    <h3 className="font-bold mb-2 line-clamp-2" style={{ color: "#1d3a5c" }}>{item.baslik}</h3>
                    {item.ozet && <p className="text-sm line-clamp-2 mb-3" style={{ color: "#6b7280" }}>{item.ozet}</p>}
      ...
      {/* ===== ETKİNLİKLER ===== */}
      {events.length > 0 && (
        <section style={{ padding: "96px 0", background: "linear-gradient(160deg,#0f1f30,#1d3a5c)" }}>
          <div className="max-w-6xl mx-auto px-6">
            <div className="flex items-end justify-between mb-12">
              <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {events.map((event) => (
                <div key={event.id} className="rounded-2xl p-6 transition-all hover:-translate-y-1"
                  ...
                  <div className="text-xs font-bold uppercase tracking-wider mb-2" style={{ color: "#e5500a", fontFamily: "Montserrat,sans-serif" }}>
                  ...
                  <div className="flex items-center gap-2 text-sm" style={{ color: "#8fd0f0" }}>
                    <Calendar size={14} />
      ...
      {/* ===== ÜYELİK CTA ===== */}
      <section style={{ padding: "96px 0", background: "linear-gradient(135deg,#c44208,#e5500a)" }}>
        <div className="max-w-2xl mx-auto px-6 text-center">
          ...
          <Link href="/uyelik" className="inline-block font-bold text-lg rounded-full transition-all hover:-translate-y-1"
            style={{ padding: "16px 44px", background: "#1d3a5c", color: "#fff", fontFamily: "Montserrat,sans-serif", boxShadow: "0 8px 24px rgba(15,31,48,.4)" }}>
            Hemen Üye Ol
          </Link>
        </div>
      </section>
